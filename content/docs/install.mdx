...
[Easypanel](https://easypanel.io) is a self-hosted Docker deployment platform, and Gopeed has a one-click deployment template there: https://easypanel.io/templates/gopeed - it sets up the download volume for you automatically.

![Gopeed running in the Easypanel panel](/images/guide/install/easypanel.png)
